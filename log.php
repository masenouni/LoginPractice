...
<style>
    ...
    .btn-larger {
        ...
        border:2px solid #397754 !important;;
    ...
    div#form {
        ...
        /*background: #1c1e21 url(https://www.pexels.com/photo/snow-top-mountain-under-clear-sky-1054218/);*/
        background-position: center center;
        background-image: url("background_three.jpg");
            ...
            <div id="userform">
                ...
                <div class="tab-content">
                    <div class="tab-pane fade active in" id="signup">
                        <h2 class="text-uppercase text-center"> Register with Us</h2>
                        <form id="signup">
                            <div class="row">
